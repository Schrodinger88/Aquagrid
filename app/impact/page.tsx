...
import { Droplets, Globe2, Activity, Sprout, Leaf, Wind } from "lucide-react";
...
export default function Impact() {
    return (
        <div className="bg-[#FAF9F6] min-h-screen font-sans text-deep-forest selection:bg-sky-blue selection:text-white">
            ...
            <section className="pt-8 px-4 sm:px-6 lg:px-8 max-w-[1400px] mx-auto">
                <div className="relative w-full h-[60vh] min-h-[500px] rounded-[2.5rem] overflow-hidden shadow-xl bg-deep-forest text-white flex flex-col items-center justify-center p-8 text-center bg-gradient-to-br from-[#0A192F] via-[#052C42] to-[#0A192F]">
                    <div className="absolute inset-0 opacity-20">
                        <div className="absolute bottom-0 left-0 w-[500px] h-[500px] bg-sky-blue rounded-full blur-[150px]" />
                    </div>
                    ...
                    <div className="relative z-10 max-w-3xl">
                        <div className="inline-flex items-center gap-2 bg-white/10 backdrop-blur-md border border-white/20 px-5 py-2 rounded-full text-sm font-bold tracking-widest uppercase mb-8 shadow-sm">
                            <Globe2 className="w-4 h-4 text-light-green" />
                            Global Impact
                        </div>
            ...
            {/* The Core Metrics - Staggered Grid */}
            <section className="py-24 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    <div className="glass-card p-10 group">
                        ...
                        <p className="text-xl font-bold text-ocean-blue mb-4">CO₂ Sequestered</p>
                        <p className="text-slate font-medium">Absorbed per module annually, functioning as the ultimate marine carbon sink.</p>
                    </div>

                    <div className="glass-card p-10 group bg-white/50">
                    ...
                    <div className="bg-deep-forest p-10 rounded-[2.5rem] text-white shadow-lg relative overflow-hidden group hover:-translate-y-1 transition-transform">
                        <div className="absolute top-0 right-0 w-40 h-40 bg-sky-blue blur-3xl opacity-30" />
                        ...
                        <p className="text-white/70 font-medium">Inside the kelp perimeter, local acidity levels stabilize entirely, creating a sanctuary for shellfish.</p>
                    </div>
                </div>
            </section>

            {/* Ecosystem Services Block */}
            <section className="pb-24 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex flex-col md:flex-row gap-8 glass-card p-8 md:p-12 item-center">
                    <div className="md:w-1/2 relative min-h-[300px] md:min-h-full rounded-[2rem] overflow-hidden group shadow-md">
                        ...
                        <div className="space-y-6">
                            ...
                            <div className="flex items-start gap-4">
                                <div className="w-12 h-12 bg-light-blue rounded-xl flex items-center justify-center shrink-0 border border-sky-blue/20">
                                    <Globe2 className="w-5 h-5 text-sky-blue" />
                                </div>
                                <div>
